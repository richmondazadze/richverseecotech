...
const BlogCategoryPage = () => {
  ...
  return (
    <main className="min-h-screen bg-white font-sans">
      <Helmet>
        <title>Category: {categoryName} | RichverseEcoTech Blog</title>
        <meta name="description" content={`Read blog posts in the category '${categoryName}' from RichverseEcoTech.`} />
        <link rel="canonical" href={`/blog/category/${category}`} />
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content={`Category: ${categoryName} | RichverseEcoTech Blog`} />
        <meta property="og:description" content={`Read blog posts in the category '${categoryName}' from RichverseEcoTech.`} />
        <meta property="og:image" content={blogPosts[0]?.image} />
        <meta property="og:url" content={`https://richverseecotech.com/blog/category/${category}`} />
        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`Category: ${categoryName} | RichverseEcoTech Blog`} />
        <meta name="twitter:description" content={`Read blog posts in the category '${categoryName}' from RichverseEcoTech.`} />
      ...
      <section className="py-8 px-2 md:px-0">
        <div className="container mx-auto flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-2/3">
            <h3 className="text-2xl font-bold text-blue-900 mb-6">Posts in {categoryName}</h3>
